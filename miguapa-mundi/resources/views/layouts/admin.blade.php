...
<head>
    ...
    <title>@yield('title', 'Miguapa Mundi - @lang('layouts.admin.Admin Panel')')</title>
</head>
        ...
        <div class="container ">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    <a class="nav-link active" href="{{route('admin.news.index')}}">@lang('layouts.admin.News')</a>
                    <a class="nav-link active" href="{{route('admin.country.index')}}">@lang('layouts.admin.Country')</a>
                    <div class="vr bg-black mx-2 d-none d-lg-block"></div>
                    <a class="nav-link active" href="{{route('country.index')}}">@lang('layouts.admin.Home')</a>
                    <form id="logout" action="{{ route('logout') }}" method="POST"> 
                        <a role="button" class="nav-link active" 
                        onclick="document.getElementById('logout').submit();">@lang('layouts.admin.Logout')</a> 
                        @csrf 
                    </form> 
                </div>
            </div>
