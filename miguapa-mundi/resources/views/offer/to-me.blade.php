...
<div class="container d-flex flex-wrap gap-3 justify-content-evenly">
    <div class="row position-fixed top-50 start-0 translate-middle z-1">
        <p class="bg-info1 m-1 p-1 rounded-pill text-end text-white fw-bold">@lang('offer.toMe.labelBtnOrder'):</p>
        <a href="{{route('offer.toMe',['orderBy'=>'price'])}}" class="btn-primary m-1 p-1 rounded-pill text-end">@lang('offer.toMe.btnAmount')</a>
        <a href="{{route('offer.toMe',['orderBy'=>'created_at'])}}" class="btn-primary m-1 p-1 rounded-pill text-end">@lang('offer.toMe.btnDate')</a>
    </div>
